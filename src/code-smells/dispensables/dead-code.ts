...
// Las declaraciones no utilizadas y las sentencias inalcanzables
// añaden ruido y coste de mantenimiento sin contribuir al comportamiento.

// Ejercicio: Arregla un bug en activeFunction
// (p. ej., cambia el manejo de negativos),

// Observa cómo el código muerto cercano dificulta razonar
// sobre lo que realmente se ejecuta,
