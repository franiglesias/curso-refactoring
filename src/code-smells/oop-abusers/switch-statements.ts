// Code smell: Switch Statements [Sentencias switch].
// El comportamiento se ramifica en códigos de tipo en lugar de usar
// polimorfismo, lo que genera lógica condicional dispersa
// que crece con cada variante.

// Ejercicio: Añade un nuevo tipo de empleado (contractor)
// con una regla de pago especial.
